							...
							foreach ($get_book as $book):
								...
								<tr>
									...
									<td class="text-center"><a
											href="<?= base_url('/transaction/addcart/' . $book->book_code) ?>"><button
												class="btn btn-outline-primary rounded-1 btn-sm" id="addcart"><span
													class="fa fa-shopping-cart" aria-hidden="true"></span></button></a></td>
								</tr>
							<?php endforeach ?>
						</tbody>
					</table>
