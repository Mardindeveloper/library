						...
						foreach ($get_book as $book):
							...
							<tr>
								...
								<td class="text-center">
									<a href="#edit" onclick="edit('<?= $book->book_code ?>')"
										class="btn btn-primary btn-sm rounded-1" data-toggle="modal"><i
											class="fa fa-pencil"></i></a>
									<a href="<?= base_url('/book/hapus/' . $book->book_code) ?>"
	...
	<div class="modal fade" id="edit">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="<?= base_url('/book/book_update') ?>" method="post" enctype="multipart/form-data">
